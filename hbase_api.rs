...
impl TDeleteType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TDeleteType> {
    ...
    TDeleteType::try_from(enum_value)  }
}

impl TryFrom<i32> for TDeleteType {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TDeleteType::DeleteColumn),
      1 => Ok(TDeleteType::DeleteColumns),
      2 => Ok(TDeleteType::DeleteFamily),
      3 => Ok(TDeleteType::DeleteFamilyVersion),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TDeleteType", i)
            )
          )
        )
      },
...
impl TDurability {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TDurability> {
    let enum_value = i_prot.read_i32()?;
    TDurability::try_from(enum_value)  }
}

impl TryFrom<i32> for TDurability {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TDurability::UseDefault),
      1 => Ok(TDurability::SkipWal),
      2 => Ok(TDurability::AsyncWal),
      3 => Ok(TDurability::SyncWal),
      4 => Ok(TDurability::FsyncWal),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TDurability", i)
            )
          )
        )
      },
...
impl TConsistency {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TConsistency> {
    let enum_value = i_prot.read_i32()?;
    TConsistency::try_from(enum_value)  }
}

impl TryFrom<i32> for TConsistency {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      1 => Ok(TConsistency::Strong),
      2 => Ok(TConsistency::Timeline),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TConsistency", i)
            )
          )
        )
      },
...
impl TReadType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TReadType> {
    let enum_value = i_prot.read_i32()?;
    TReadType::try_from(enum_value)  }
}

impl TryFrom<i32> for TReadType {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      1 => Ok(TReadType::Default),
      2 => Ok(TReadType::Stream),
      3 => Ok(TReadType::Pread),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TReadType", i)
            )
          )
        )
      },
...
impl TCompareOperator {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TCompareOperator> {
    let enum_value = i_prot.read_i32()?;
    TCompareOperator::try_from(enum_value)  }
}

impl TryFrom<i32> for TCompareOperator {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TCompareOperator::Less),
      1 => Ok(TCompareOperator::LessOrEqual),
      2 => Ok(TCompareOperator::Equal),
      3 => Ok(TCompareOperator::NotEqual),
      4 => Ok(TCompareOperator::GreaterOrEqual),
      5 => Ok(TCompareOperator::Greater),
      6 => Ok(TCompareOperator::NoOp),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TCompareOperator", i)
            )
          )
        )
      },
...
impl TBloomFilterType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TBloomFilterType> {
    let enum_value = i_prot.read_i32()?;
    TBloomFilterType::try_from(enum_value)  }
}

impl TryFrom<i32> for TBloomFilterType {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TBloomFilterType::None),
      1 => Ok(TBloomFilterType::Row),
      2 => Ok(TBloomFilterType::Rowcol),
      3 => Ok(TBloomFilterType::RowprefixFixedLength),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TBloomFilterType", i)
            )
          )
        )
      },
...
#[derive(Copy, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub enum TCompressionAlgorithm {
  Lzo = 0,
  Gz = 1,
  None = 2,
  Snappy = 3,
...
impl TCompressionAlgorithm {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TCompressionAlgorithm> {
    let enum_value = i_prot.read_i32()?;
    TCompressionAlgorithm::try_from(enum_value)  }
}

impl TryFrom<i32> for TCompressionAlgorithm {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TCompressionAlgorithm::Lzo),
      1 => Ok(TCompressionAlgorithm::Gz),
      2 => Ok(TCompressionAlgorithm::None),
      3 => Ok(TCompressionAlgorithm::Snappy),
      4 => Ok(TCompressionAlgorithm::Lz4),
      5 => Ok(TCompressionAlgorithm::Bzip2),
      6 => Ok(TCompressionAlgorithm::Zstd),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TCompressionAlgorithm", i)
            )
          )
        )
      },
...
impl TDataBlockEncoding {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TDataBlockEncoding> {
    let enum_value = i_prot.read_i32()?;
    TDataBlockEncoding::try_from(enum_value)  }
}

impl TryFrom<i32> for TDataBlockEncoding {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TDataBlockEncoding::None),
      2 => Ok(TDataBlockEncoding::Prefix),
      3 => Ok(TDataBlockEncoding::Diff),
      4 => Ok(TDataBlockEncoding::FastDiff),
      7 => Ok(TDataBlockEncoding::RowIndexV1),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TDataBlockEncoding", i)
            )
          )
        )
      },
...
impl TKeepDeletedCells {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TKeepDeletedCells> {
    let enum_value = i_prot.read_i32()?;
    TKeepDeletedCells::try_from(enum_value)  }
}

impl TryFrom<i32> for TKeepDeletedCells {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TKeepDeletedCells::False),
      1 => Ok(TKeepDeletedCells::True),
      2 => Ok(TKeepDeletedCells::Ttl),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TKeepDeletedCells", i)
            )
          )
        )
      },
...
impl TLogType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TLogType> {
    let enum_value = i_prot.read_i32()?;
    TLogType::try_from(enum_value)  }
}

impl TryFrom<i32> for TLogType {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      1 => Ok(TLogType::SlowLog),
      2 => Ok(TLogType::LargeLog),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TLogType", i)
            )
          )
        )
      },
...
impl TFilterByOperator {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TFilterByOperator> {
    let enum_value = i_prot.read_i32()?;
    TFilterByOperator::try_from(enum_value)  }
}

impl TryFrom<i32> for TFilterByOperator {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      0 => Ok(TFilterByOperator::And),
      1 => Ok(TFilterByOperator::Or),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TFilterByOperator", i)
            )
          )
        )
      },
...
impl TThriftServerType {
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TThriftServerType> {
    let enum_value = i_prot.read_i32()?;
    TThriftServerType::try_from(enum_value)  }
}

impl TryFrom<i32> for TThriftServerType {
  type Error = thrift::Error;  fn try_from(i: i32) -> Result<Self, Self::Error> {
    match i {
      1 => Ok(TThriftServerType::One),
      2 => Ok(TThriftServerType::Two),
      _ => {
        Err(
          thrift::Error::Protocol(
            ProtocolError::new(
              ProtocolErrorKind::InvalidData,
              format!("cannot convert enum constant {} to TThriftServerType", i)
            )
          )
        )
      },
...
impl TIOError {
  pub fn new<F1>(message: F1) -> TIOError where F1: Into<Option<String>> {
    TIOError {
...
impl Error for TIllegalArgument {
  fn description(&self) -> &str {
    "remote service threw TIllegalArgument"
  }
}
